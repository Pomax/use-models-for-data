...
export class Models {
  ...
  static create = function (Model, data, allowIncomplete) {
    ...
    if (!result.passed) {
      const err = Errors.REQUIRED_FIELDS_MISSING(name);
   ...
   */
  static loadModel = async function (Model, recordName) {
    this.verifyStore();
   ...
   */
  static saveModel = async function (instance) {
    this.verifyStore();
        ...
        Object.defineProperty(model, key, {
          ...
          set: (data) => {
            if (!(data instanceof Array)) {
              throw Errors.ASSIGNMENT_MUST_BE_ARRAY;
            }
        ...
        Object.defineProperty(model, key, {
          ...
          set: (data) => {
            ...
            if (result.passed) setDataFrom(data, definition);
              ...
              const err = Errors.ASSIGNMENT_VIOLATES_SCHEMA;
              err.errors = result.errors;
              throw err;
            }
          },
  ...
  Object.defineProperty(model, key, {
    ...
    set: (value) => {
      ...
      if (result.passed) {
        ...
        const err = Errors.INVALID_ASSIGNMENT(key, value);
        err.errors = result.errors;
        throw err;
      }
    },
