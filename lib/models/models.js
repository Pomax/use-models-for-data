...
export class Models {
  ...
  static create(Model, data, allowIncomplete) {
    ...
    if (!result.passed) {
      throw new REQUIRED_FIELDS_MISSING(name, result.errors);
    }
        ...
        Object.defineProperty(model, key, {
          ...
          set: (data) => {
            if (!(data instanceof Array)) {
              throw new ASSIGNMENT_MUST_BE_ARRAY(key);
            }
        ...
        Object.defineProperty(model, key, {
          ...
          set: (data) => {
            ...
            if (result.passed) setDataFrom(data, definition);
              ...
              throw new INVALID_ASSIGNMENT(key, data, result.errors);
            }
          },
        });
      }
  ...
  Object.defineProperty(model, key, {
    ...
    set: (value) => {
      ...
      if (result.passed) {
        ...
        throw new INVALID_ASSIGNMENT(key, value, result.errors);
      }
    },
  });
}
