...
export class Model {
   ...
   *
   * <p>Note that this data must be schema-conformant or the
   * create function will throw.</p>
   *
   ...
   */
  static create(allowIncomplete) {
    if (allowIncomplete && allowIncomplete !== this.ALLOW_INCOMPLETE) {
      throw new ModelCreateWithData(this.name);
    }
  ...
  /**
   * <p>Similar to {@link create()}, except that a data object is <em>required</em>.</p>
   *
   * <p>If no data is provided, this method will throw.</p>
   *
   * <p>If a backend store is used, this function will run <code>async</code>,
   * returning a <code>Promise</code> that can be <code>await</code>ed,
   * or handled with <code>.then()</code></p>
