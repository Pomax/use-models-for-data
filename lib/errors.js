...
export class SchemaMismatchForModels extends Error {
  /**
   ...
   * @name Errors.SchemaMismatchForModels
   * @member
   * @param {String[]} modelNames - The names of each Model with pending migrations.
   */
  constructor(...modelNames) {
    ...
    this.message = `Schema mismatch for ${names}, please migrate your data first.`;
    this.names = names;
  }
}
