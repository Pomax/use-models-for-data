 ...
 * @param {*} [results]
 * @param {*} [prefix]
 * @returns {object} Result object with <code>passed</code> boolean and warnings/error arrays
 * @ignore
 */
...
/**
 * Test an array of values (in-situ) to see whether all of them conform to the associated schema
 * @param {*} object
 * @param {*} field_name
 * @param {*} schema
 * @param {*} strict
